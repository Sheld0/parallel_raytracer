...
ifeq ($(DEBUG),yes)
  CXXFLAGS=-std=c++11 -fopenmp -pthread -g -O0 -Wall -pedantic -D_GLIBCXX_DEBUG
else
  CXXFLAGS=-std=c++11 -fopenmp -pthread -O3 -Wall -march=native
...
check:
	time -p mpirun -np $(THREADS) $(TARGET)
	md5sum untitled.ppm
